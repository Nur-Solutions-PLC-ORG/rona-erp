    ...
    <div className="overflow-hidden rounded-xl border border-slate-200 bg-card shadow-sm">
      <header className="flex flex-col gap-3 border-b border-slate-200 px-4 py-3 sm:flex-row sm:items-center sm:justify-between sm:px-5">
            ...
            {FILTER_TABS.map((tab) => (
              <button
                ...
                className={cn(
                  ...
                  filter === tab.key
                    ? "bg-card text-slate-700 shadow-sm"
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-1.5 self-start rounded-md border border-slate-200 bg-card px-3 py-1.5 text-xs font-medium text-slate-600 transition-colors hover:bg-slate-50 disabled:opacity-40 sm:self-auto"
        >
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center gap-1.5 px-4 py-12 text-center">
          ...
          <Link
            ...
            className="mt-2 inline-flex items-center gap-1.5 rounded-lg bg-primary px-4 py-2 text-xs font-medium text-primary-foreground transition-colors hover:bg-primary/90"
          >
