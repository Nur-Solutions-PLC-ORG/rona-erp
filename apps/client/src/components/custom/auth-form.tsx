...
export const AUTH_INPUT =
  "w-full px-3.5 py-2.5 rounded-md bg-zinc-50 border border-zinc-200/70 text-zinc-800 placeholder-zinc-400 focus:outline-none focus:ring-1 focus:ring-ring focus:border-ring focus:bg-card transition text-sm";
...
export const AUTH_OUTLINE_BUTTON =
  "w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-md bg-card hover:bg-zinc-50 text-zinc-700 text-sm font-medium transition border border-zinc-200 disabled:opacity-50 disabled:pointer-events-none";
