  ...
  return (
    <article>
      ...
      <Section title="Forward tracing">
        ...
        <Card shadow>
          <div className="space-y-2 font-mono text-[12.5px] text-ink">
            ...
            <p className="border-t border-tint-2 pt-2 font-sans text-[13px] font-semibold">
      ...
      <Section title="Multi-hop tracing">
        ...
        <Card shadow>
          <div className="space-y-3 font-mono text-[12.5px] text-ink">
            <div>
              <p className="font-sans text-[12px] font-bold uppercase tracking-widest text-ink-3">
            ...
            <p className="border-t border-tint-2 pt-2">
