...
const sidebar = [
  ...
  { icon: HiOutlineCube, label: "Items", scene: "items" as SceneId },
  {
    ...
    label: "Warehouses",
    scene: "items" as SceneId,
  },
  {
    icon: HiOutlineArrowsRightLeft,
    label: "Movements",
    scene: "movements" as SceneId,
  },
...
const attention = [
  {
    label: "White Sugar",
    detail: "Quarantined lot · LOT-2026-010",
    type: "warn" as const,
  },
  {
    label: "Wheat Flour",
    detail: "Expired lot · LOT-2025-090",
    type: "error" as const,
  },
  {
    label: "Vanilla Cake",
    detail: "Below reorder point (12 < 20)",
    type: "warn" as const,
  },
];
...
const traceSteps = [
  ...
  },
  {
    icon: HiOutlineClipboard,
    title: "Inspected",
    detail: "Quality inspection · approved",
    source: "QA gate",
    time: "09:45 AM",
  },
  {
    ...
    title: "Reserved",
    detail: "50 KG reserved for production",
    source: "PO-2026-001",
    time: "10:02 AM",
  },
  {
    ...
    title: "Consumed",
    detail: "Consumed 50.0000 KG · AISLE-A-01",
    source: "BOM-BREAD",
    time: "11:30 AM",
  },
  {
    ...
    title: "Produced",
    detail: "FG-LOT-2026-001 · 95% yield",
    source: "Bread Loaf",
    time: "02:15 PM",
  },
  {
...
function StatusChip({ status }: { status: string }) {
  ...
  return (
    <span
      className={`inline-block rounded px-1.5 py-0.5 text-[9px] font-semibold ${tone}`}
    >
      {status}
    </span>
  );
        ...
        <div className="flex flex-1 min-h-0">
          ...
          <div className="relative flex-1 min-w-0 min-h-0">
            {scene === "dashboard" && (
              <div
                key="dashboard"
                className="absolute inset-0 flex flex-col gap-3 px-3 sm:px-4 py-3 overflow-hidden animate-scene-video"
              >
                  ...
                  {kpis.map((kpi) => (
                    ...
                    >
                      ...
                      <div className="flex items-baseline gap-1.5 mt-1">
                        ...
                        {kpi.trend && (
                          <span
                            className={`text-[9px] font-semibold ${kpi.up ? "text-emerald-600" : "text-rose-500"}`}
                          >
                            {kpi.trend}
                          </span>
                        )}
                      ...
                      <table className="w-full text-[10px]">
                        <thead>
                          <tr className="bg-slate-50 border-b border-slate-100">
                            {["Reference", "Item", "Qty", "Type", "Status"].map(
                              (col) => (
                                <th
                                  key={col}
                                  className="px-3 py-1.5 text-left font-semibold text-slate-500 uppercase tracking-wider"
                                >
                                  {col}
                                </th>
                              ),
                          ...
                          {movements.slice(0, 6).map((row, i) => (
                            ...
                            >
                              ...
                              <td className="px-3 py-2 text-slate-500">
                                <span
                                  className={`inline-block rounded px-1.5 py-0.5 text-[8px] font-medium ${
                                    row.type === "Inbound"
                        ...
                        {attention.map((item) => (
                          ...
                          >
                            <div className="flex items-center gap-1.5">
                              <div
                                className={`w-1.5 h-1.5 rounded-full shrink-0 ${item.type === "error" ? "bg-rose-500" : "bg-amber-400"}`}
                              />
                              <div className="text-[11px] font-semibold text-slate-800 truncate">
                                {item.label}
                              </div>
                            </div>
                            <div className="text-[9px] text-slate-400 mt-0.5 ml-3">
                              {item.detail}
                            </div>
                          </div>
                        ))}
                        ...
                        {itemsRows.map((row, i) => (
                          ...
                          >
                            ...
                            <td className="px-3 py-2.5">
                              <span
                                className={`inline-block rounded px-1.5 py-0.5 text-[8px] font-medium ${
                                  row.cat === "Raw Material"
                                    ? "bg-blue-50 text-blue-600"
                                    : row.cat === "Finished Good"
                                      ? "bg-emerald-50 text-emerald-600"
                                      : "bg-zinc-100 text-zinc-600"
                                }`}
                              >
