...
import { MODULE_LIST, POSITIONS_LIST, USER_STATUS_LIST, } from "@rona/config/auth";
...
export const companyListSearchParamsSchema = paginationSearchParamsSchema.extend({
    status: z.enum(COMPANY_STATUS_LIST).optional(),
});
export const employeeListSearchParamsSchema = paginationSearchParamsSchema.extend({
...
export const companySettingsListSearchParamsSchema = paginationSearchParamsSchema;
// Tables schema
