 ...
 */
export const API_ADMIN_COMPANY_SETTINGS_BY_ID_URL = "/api/admin/company-settings/:id";
/**
 * Methods: GET, PUT, DELETE
 * RequestBody: CompanySettingsSchema
 ...
 */
export const API_ADMIN_PLATFORM_CONFIG_BY_KEY_URL = "/api/admin/platform-configs/:key";
/**
 * Methods: GET, PUT
 * RequestBody: PlatformConfigSchema
