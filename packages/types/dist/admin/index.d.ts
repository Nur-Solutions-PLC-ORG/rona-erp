...
import { branchDto, branchListSearchParamsSchema, branchSchema, companyDto, companyListSearchParamsSchema, companySchema, companySettingsDto, companySettingsSchema, departmentDto, departmentListSearchParamsSchema, departmentSchema, employeeDto, employeeListSearchParamsSchema, employeeSchema, platformConfigDto, platformConfigSchema, userListSearchParamsSchema, userSchema, companySettingsListSearchParamsSchema, configsListSearchParamsSchema } from "@rona/validation/admin";
import z from "zod";
...
export type UserListSearchParamsSchema = z.infer<typeof userListSearchParamsSchema>;
export type CompanyListSearchParamsSchema = z.infer<typeof companyListSearchParamsSchema>;
export type EmployeeListSearchParamsSchema = z.infer<typeof employeeListSearchParamsSchema>;
export type DepartmentListSearchParamsSchema = z.infer<typeof departmentListSearchParamsSchema>;
export type BranchListSearchParamsSchema = z.infer<typeof branchListSearchParamsSchema>;
export type ConfigsListSearchParamsSchema = z.infer<typeof configsListSearchParamsSchema>;
export type CompanySettingsListSearchParamsSchema = z.infer<typeof companySettingsListSearchParamsSchema>;
